...
public class EnterJdbcServices
{
    ...
    {
        String res = "0";
        String packageOutPath = vopage + ".services";
    ...
    private String parse(String tablename, String vopage, String index)
    {
        ...
        sb.append("package " + vopage + ".services;\r\n");
        sb.append("\r\n");
        
        sb.append("import java.util.*;\r\n");
        sb.append("import com.*;\r\n");
        sb.append("import " + vopage + ".vo." + Util.initcap(tablename) + ";\r\n");
        if (this.f_util)
        {
        ...
        sb.append("    public HashMap get" + Util.initcap(tablename)
            + "(Object[] obj,HashMap parms) throws Exception{\r\n\r\n");
