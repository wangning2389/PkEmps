...
public class EnterJdbcJsp
{
  ...
  public String createJsp(String tablename, String vopage, String index) throws Exception
  {
    ...
    if ("0".equals(this.res)) this.res = createJspForModify(tablename, vopage, index);
    return this.res;
  }
  ...
  public String createJspForQuery(String tablename, String vopage, String index)
  {
    ...
    try
    {
      ...
      {
        sb.append("       <div field=\"" + this.colnames[j].toLowerCase() + "\" width=\"120\" headerAlign=\"center\" allowSort=\"true\">" + this.colnames[j] + "</div>\r\n");
      }
  ...
  public String createJspForModify(String tablename, String vopage, String index)
  {
    ...
    try
    {
      ...
      for (int j = 0; j < this.colnames.length; j++)
      {
        ...
        if ("NUMBER".equals(this.colTypes[j])) dataType = "vtype=\"int\"";
        ...
        sb.append("<td style=\"width:30%;\"><input name=\"" + this.colnames[j].toLowerCase() + "\" class=\"" + dataClass + "\" required=\"true\" " + dataType + "  emptyText=\"请输入" + this.colnames[j] + "\"/></td>\r\n");
        if (j % 2 != 0)
          continue;
        if (j == this.colnames.length - 1) sb.append("</tr>\r\n"); else {
          sb.append("</tr>\r\n<tr>\r\n");
        }
