...
public class EnterJdbcAction
{
    ...
    {
        String res = "0";
        String packageOutPath = vopage + ".action";
        ...
        try
        {
            ...
            String outputPath = Const.path + "/src/" + packageOutPath.replace(".", "/") + "/" + Util.initcap(tablename)
                + "Action.java";
    ...
    private String parse(String tablename, String vopage, String index)
    {
        ...
        sb.append("package " + vopage + ".action;\r\n");
        sb.append("\r\n");
        ...
        sb.append("import " + vopage + ".services." + Util.initcap(tablename) + "Services;\r\n");
        if (this.f_util)
        {
        ...
        sb.append("    " + Util.initcap(tablename) + "Services ss=new " + Util.initcap(tablename)
            + "Services();\r\n\r\n");
        ...
        sb.append("    public void get" + Util.initcap(tablename)
            + "(HttpServletRequest request, HttpServletResponse response) throws Exception{\r\n\r\n");
        
        sb.append("        HashMap parms=sys.getGridSort(request);\r\n");
        sb.append("        String json = Util.Encode(ss.get" + Util.initcap(tablename)
            + "(new Object[] {},parms));\r\n");
        sb.append("        Component.print(json, response);\r\n");
        sb.append("    } \r\n\r\n\r\n\r\n");
        
        sb.append("    @RequestMapping(params =\"method=remove" + tablename + "\")\r\n");
        sb.append("    public void remove" + Util.initcap(tablename)
            + "(HttpServletRequest request, HttpServletResponse response) throws Exception{\r\n\r\n");
        ...
        sb.append("    public void get" + Util.initcap(tablename)
            + "Data(HttpServletRequest request, HttpServletResponse response) throws Exception{\r\n\r\n");
        sb.append("        HashMap user = ss.get" + Util.initcap(tablename)
            + "Data(Component.getQuest(\"id\", request));\r\n");
        sb.append("         Component.print(Util.Encode(user), response);\r\n");
        sb.append("    } \r\n\r\n\r\n\r\n");
        
        sb.append("    @RequestMapping(params =\"method=save" + tablename + "\")\r\n");
        sb.append("    public void save" + Util.initcap(tablename)
            + "(HttpServletRequest request, HttpServletResponse response) throws Exception{\r\n\r\n");
        ...
        sb.append("       String id = row.get(\"" + index + "\") != null ? row.get(\"" + index
            + "\").toString() : \"\";\r\n");
