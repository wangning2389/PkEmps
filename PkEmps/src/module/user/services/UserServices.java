...
public class UserServices
{
    ...
    // 取菜单列表
    public HashMap getExpUserList(Object[] obj, String exptype, HashMap parms)
        throws Exception
    {
        ...
        // 设置sql语句
        String sql = "select * from EXP_USER " + "where ('" + obj[0] + "' is null or name like '%'||?||'%') and ('"
            + obj[1] + "' is null or major like ''||?||'%')" + "and ('" + obj[2]
            + "' is null or subject like ''||?||'%')and ('" + obj[3] + "' is null or filed like ''||?||'%')and ('"
            + obj[4] + "' is null or verifystatus = ?)and ('" + obj[5]
            + "' is null or to_char(subtime,'yyyy-mm-dd')= ?) and ('" + obj[6] + "' is null or status = ?) and ('"
            + obj[7] + "' is null or profgrade = ?) and(" + sb.toString() + ") order by id desc";
     ...
     * @throws Exception
     */
    public String insertExpInfo(HashMap obj)
        throws Exception
    {
     ...
     * @throws Exception
     */
    public String modifiedExpInfo(HashMap obj)
        throws Exception
    {
    ...
    public List getSelect(String type)
        throws Exception
    {
     ...
     * @throws Exception
     */
    public HashMap getExpUserData(int id)
        throws Exception
    {
    ...
    public void deleteExpUser(int id, String reason)
        throws Exception
    {
        ...
        throws Exception
    {
        ...
        String sql = "select m.* from C_MENU m left join C_USER_MENU um on m.id=um.menu_id left join C_USER u on u.id=um.user_id where u.username=? ";
        List data = sys.query(sql, new Object[] {username}, true);
        return data;
    }
    
    public void verifyExpInfo(int id, String verifystatus)
        throws Exception
    {
        // TODO Auto-generated method stub
        Exp_User bo = new Exp_User();
    ...
    public List getMeetingHistory(int id)
        throws Exception
    {
