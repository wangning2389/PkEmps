...
import module.project.services.ProjectApplyServices;
    ...
    */ 
    ...
    public void getProjectApply(HttpServletRequest request, HttpServletResponse response) throws Exception{
    ...
    public void removeProjectApply(HttpServletRequest request, HttpServletResponse response) throws Exception{
    ...
    public void getProjectApplyData(HttpServletRequest request, HttpServletResponse response) throws Exception{
    ...
    public void saveProjectApply(HttpServletRequest request, HttpServletResponse response) throws Exception{

       String json=request.getParameter("data");
       ArrayList rows = (ArrayList)Util.Decode(json);
       HashMap row = (HashMap)rows.get(0);
       String id = row.get("ID") != null ? row.get("ID").toString() : "";
       if(id.equals(""))ss.insertProjectApply(row);
       else ss.modifiedProjectApply(row);
    } 
