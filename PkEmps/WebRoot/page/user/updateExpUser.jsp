				...
				<div style="padding-left: 11px; padding-bottom: 5px;">
					...
					<tr height="34">
						<td  align="right" nowrap="nowrap">
							...
							<td  colspan="3" ><input id="fileupload1" class="mini-fileupload" name="photo" limitType="*.jpg;*.png;*.bmp;*.gif" 
				...
				<div style="padding-left: 11px; padding-bottom: 5px;">
					<table >
						...
						<tr height="34">
							...
							<td >
								<input name="major" id="major" class="mini-treeselect" url="${pageContext.request.contextPath }/module/user.do?method=getselect&type=major" multiSelect="false"  valueFromSelect="true"
       								 textField="text" valueField="code" parentField="parent_code"  onbeforenodeselect="beforenodeselect" allowInput="true"
        								showRadioButton="true" showFolderCheckBox="false"style="width: 185px;"  required="true"/>
							</td>
							<td  align="right" nowrap="nowrap">
							...
							<td >
								<input name="subject" id="subject" class="mini-treeselect" url="${pageContext.request.contextPath }/module/user.do?method=getselect&type=subject" multiSelect="false"  valueFromSelect="true"
       								 textField="text" valueField="code" parentField="parent_code"  onbeforenodeselect="beforenodeselect" allowInput="true"
        								showRadioButton="true" showFolderCheckBox="false"style="width: 185px;" required="true"
   							 />
							</td>
	...
	function SaveData() {
		...
		$.ajax( {
			...
			success : function(text) {
				mini.alert("专家信息修改成功！", "提示", function() {
					CloseWindow();
				});
			},
